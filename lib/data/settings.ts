...
export const defaultSiteSettings: SiteSettings = {
  ...
  category_carousel_mobile_count: 3,
  category_carousel_desktop_count: 6,
  category_carousel_interval_seconds: 5,
  product_carousel_mobile_count: 2,
  product_carousel_desktop_count: 4,
  product_carousel_interval_seconds: 5,
  similar_products_mobile_count: 2,
  similar_products_desktop_count: 4,
  similar_products_interval_seconds: 5,
  price_color: "#10C44C",
